...
{
    //For Query responses, we want to be using primitive types as much as possible
    // and we want a very pledge structure which we can easily return from the database
